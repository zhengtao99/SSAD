...
/// <summary>
/// A manager responsible for displaying of questions, managing the interactions between players and the game, as well as giving out rewards or penalties for every question answered.
/// </summary>
public class QAManager : MonoBehaviour
{
    ...
    /// <summary>
    /// The method takes in a list of answers and populate the text in the answer buttons in the question page.
    /// </summary>
    ...
    /// <summary>
    /// The method is responsible to populate the question page with a question.
    /// </summary>
    ...
    /// <summary>
    /// The method is responsible enable the buttons when the question page is active to allow the player to choose an answer for the question.
    /// </summary>
    void EnableButtons()
    {
    ...
    /// <summary>
    /// The method is responsible for disabling the buttons to prevent unwanted interactions that may cause error after the player has answered the question.
    /// </summary>
    void DisableButtons()
    {
        GameObject[] buttons = GameObject.FindGameObjectsWithTag("AnswerButton");
    ...
    /// <summary>
    /// The method is responsible verify and update the players points or lifes in cases where the player answer the question correctly or wrongly.
    /// </summary>
    ...
    /// <summary>
    /// The method is responsible for continuing the game once the player pressed on continue button.
    /// </summary>
    ...
    /// <summary>
    /// The method is responsible changing answer button to red color to show wrong answer has be selected.
    /// </summary>
    public void TurnRed()
    {
    ...
    /// <summary>
    /// The method is responsible changing answer button to green color to show correct answer has be selected.
    /// </summary>
